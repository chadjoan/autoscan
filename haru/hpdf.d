...
public import haru.hpdf_consts;
public import haru.hpdf_types;
public import haru.hpdf_error;
...
alias void*         HPDF_HANDLE;
alias HPDF_HANDLE   HPDF_Doc;
alias HPDF_HANDLE   HPDF_Page;
alias HPDF_HANDLE   HPDF_Pages;
alias HPDF_HANDLE   HPDF_Stream;
alias HPDF_HANDLE   HPDF_Image;
alias HPDF_HANDLE   HPDF_Font;
alias HPDF_HANDLE   HPDF_Outline;
alias HPDF_HANDLE   HPDF_Encoder;
alias HPDF_HANDLE   HPDF_Destination;
alias HPDF_HANDLE   HPDF_XObject;
alias HPDF_HANDLE   HPDF_Annotation;
alias HPDF_HANDLE   HPDF_ExtGState;
alias HPDF_HANDLE   HPDF_FontDef;
alias HPDF_HANDLE   HPDF_U3D;
alias HPDF_HANDLE   HPDF_Error;
alias HPDF_HANDLE   HPDF_MMgr;
alias HPDF_HANDLE   HPDF_Dict;
alias HPDF_HANDLE   HPDF_EmbeddedFile;
alias HPDF_HANDLE   HPDF_OutputIntent;
alias HPDF_HANDLE   HPDF_Xref;
...
extern(C) const(char*) HPDF_GetVersion();
...
extern(C) HPDF_LineCap
HPDF_Page_GetLineCap  (HPDF_Page   page);


extern(C) HPDF_LineJoin
...
extern(C) HPDF_TextRenderingMode
