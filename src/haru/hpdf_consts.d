...
module haru.hpdf_consts;

import haru.hpdf_types;
...
enum HPDF_TMP_BUF_SIZ            = 512;
enum HPDF_SHORT_BUF_SIZ          = 32;
enum HPDF_REAL_LEN               = 11;
enum HPDF_INT_LEN                = 11;
enum HPDF_TEXT_DEFAULT_LEN       = 256;
enum HPDF_UNICODE_HEADER_LEN     = 2;
enum HPDF_DATE_TIME_STR_LEN      = 23;

/* length of each item defined in PDF */
enum HPDF_BYTE_OFFSET_LEN        = 10;
enum HPDF_OBJ_ID_LEN             = 7;
enum HPDF_GEN_NO_LEN             = 5;

/* default value of Graphic State */
enum HPDF_DEF_FONT               = "Helvetica";
enum HPDF_DEF_PAGE_LAYOUT        = HPDF_PAGE_LAYOUT_SINGLE;
enum HPDF_DEF_PAGE_MODE          = HPDF_PAGE_MODE_USE_NONE;
enum HPDF_DEF_WORDSPACE          = 0;
enum HPDF_DEF_CHARSPACE          = 0;
enum HPDF_DEF_FONTSIZE           = 10;
enum HPDF_DEF_HSCALING           = 100;
enum HPDF_DEF_LEADING            = 0;
enum HPDF_DEF_RENDERING_MODE     = HPDF_FILL;
enum HPDF_DEF_RISE               = 0;
enum HPDF_DEF_RAISE              = HPDF_DEF_RISE;
enum HPDF_DEF_LINEWIDTH          = 1;
enum HPDF_DEF_LINECAP            = HPDF_BUTT_END;
enum HPDF_DEF_LINEJOIN           = HPDF_MITER_JOIN;
enum HPDF_DEF_MITERLIMIT         = 10;
enum HPDF_DEF_FLATNESS           = 1;
enum HPDF_DEF_PAGE_NUM           = 1;

enum HPDF_BS_DEF_WIDTH           = 1;

/* defalt page-size */
enum HPDF_DEF_PAGE_WIDTH         = 595.276F;
enum HPDF_DEF_PAGE_HEIGHT        = 841.89F;

/*---------------------------------------------------------------------------*/
/*----- compression mode ----------------------------------------------------*/

mixin dequalifyEnum!HPDF_COMP;
mixin toStringifyFlags!HPDF_COMP;
enum HPDF_COMP
{
    HPDF_COMP_NONE            = 0x00,
    HPDF_COMP_TEXT            = 0x01,
...
mixin dequalifyEnum!HPDF_ENABLE;
mixin toStringifyFlags!HPDF_ENABLE;
enum HPDF_ENABLE
{
    HPDF_ENABLE_READ        = 0,
    HPDF_ENABLE_PRINT       = 4,
...
mixin dequalifyEnum!HPDF_VIEWER_PREFERENCES;
mixin toStringifyFlags!HPDF_VIEWER_PREFERENCES;
enum HPDF_VIEWER_PREFERENCES
{
    HPDF_HIDE_TOOLBAR    = 1,
    HPDF_HIDE_MENUBAR    = 2,
...
enum HPDF_LIMIT_MAX_INT             = 2147483647;
enum HPDF_LIMIT_MIN_INT             = -2147483647;

enum HPDF_LIMIT_MAX_REAL            = 32767;
enum HPDF_LIMIT_MIN_REAL            = -32767;

enum HPDF_LIMIT_MAX_STRING_LEN      = 65535;
enum HPDF_LIMIT_MAX_NAME_LEN        = 127;

enum HPDF_LIMIT_MAX_ARRAY           = 8191;
enum HPDF_LIMIT_MAX_DICT_ELEMENT    = 4095;
enum HPDF_LIMIT_MAX_XREF_ELEMENT    = 8388607;
enum HPDF_LIMIT_MAX_GSTATE          = 28;
enum HPDF_LIMIT_MAX_DEVICE_N        = 8;
enum HPDF_LIMIT_MAX_DEVICE_N_V15    = 32;
enum HPDF_LIMIT_MAX_CID             = 65535;
enum HPDF_MAX_GENERATION_NUM        = 65535;

enum HPDF_MIN_PAGE_HEIGHT           = 3;
enum HPDF_MIN_PAGE_WIDTH            = 3;
enum HPDF_MAX_PAGE_HEIGHT           = 14400;
enum HPDF_MAX_PAGE_WIDTH            = 14400;
enum HPDF_MIN_MAGNIFICATION_FACTOR  = 8;
enum HPDF_MAX_MAGNIFICATION_FACTOR  = 3200;

/*---------------------------------------------------------------------------*/
/*------ limitation of various properties -----------------------------------*/

enum HPDF_MIN_PAGE_SIZE          = 3;
enum HPDF_MAX_PAGE_SIZE          = 14400;
enum HPDF_MIN_HORIZONTALSCALING  = 10;
enum HPDF_MAX_HORIZONTALSCALING  = 300;
enum HPDF_MIN_WORDSPACE          = -30;
enum HPDF_MAX_WORDSPACE          = 300;
enum HPDF_MIN_CHARSPACE          = -30;
enum HPDF_MAX_CHARSPACE          = 300;
enum HPDF_MAX_FONTSIZE           = 300;
enum HPDF_MAX_ZOOMSIZE           = 10;
enum HPDF_MAX_LEADING            = 300;
enum HPDF_MAX_LINEWIDTH          = 100;
enum HPDF_MAX_DASH_PATTERN       = 100;

enum HPDF_MAX_JWW_NUM            = 128;

/*----------------------------------------------------------------------------*/
/*----- country code definition ----------------------------------------------*/

mixin dequalifyEnum!HPDF_COUNTRY;
enum HPDF_COUNTRY : string
{
...
mixin dequalifyEnum!HPDF_LANG;
enum HPDF_LANG : string
{
...
mixin dequalifyEnum!HPDF_GMODE;
mixin toStringifyFlags!HPDF_GMODE;
enum HPDF_GMODE
{
