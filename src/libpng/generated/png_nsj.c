...
#endif
#define PNG_NSJ_png_convert_to_rfc1123_buffer_IS_DEFINED 1
...
#define PNG_NSJ_png_get_eXIf_IS_DEFINED 1

#define PNG_NSJ_png_set_eXIf_IS_DEFINED 1

#define PNG_NSJ_png_get_eXIf_1_IS_DEFINED 1

#define PNG_NSJ_png_set_eXIf_1_IS_DEFINED 1
...
#define PNG_NSJ_png_get_palette_max_IS_DEFINED 1
...
#ifdef PNG_STDIO_SUPPORTED
#define PNG_NSJ_png_image_begin_read_from_file_IS_DEFINED 1

   

#define PNG_NSJ_png_image_begin_read_from_stdio_IS_DEFINED 1

   
#endif 

#define PNG_NSJ_png_image_begin_read_from_memory_IS_DEFINED 1

   

#define PNG_NSJ_png_image_finish_read_IS_DEFINED 1

   

#define PNG_NSJ_png_image_free_IS_DEFINED 1
...
#define PNG_NSJ_png_image_write_to_file_IS_DEFINED 1

   

#define PNG_NSJ_png_image_write_to_stdio_IS_DEFINED 1

   
#endif 

#define PNG_NSJ_png_image_write_to_memory_IS_DEFINED 1
...
#define PNG_NSJ_png_set_option_IS_DEFINED 1
...
#define PNG_NSJ_png_write_frame_tail_IS_DEFINED 1
 ...
 void png_nsj_set_sig_bytes(d_png_structrp png_ptr, int num_bytes)
{
...
#   endif
 ...
 size_t png_nsj_get_compression_buffer_size(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_compression_buffer_size(d_png_structrp png_ptr,
    size_t size)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
PNG_DEPRECATED int png_nsj_reset_zstream(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#pragma GCC diagnostic pop
 ...
 void png_nsj_write_sig(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_write_chunk(d_png_structrp png_ptr, png_const_bytep
...
#   endif
 ...
 void png_nsj_write_chunk_start(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_write_chunk_data(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_write_chunk_end(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_infop png_nsj_create_info_struct(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_write_info_before_PLTE(d_png_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_write_info(d_png_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_read_info(d_png_structrp png_ptr, png_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
PNG_DEPRECATED png_const_charp png_nsj_convert_to_rfc1123(d_png_structrp png_ptr,
...
#pragma GCC diagnostic pop
 ...
 int png_nsj_convert_to_rfc1123_buffer(libpngCallContextForD *dCallContext, char out[29],
    png_const_timep ptime)
{
#   if PNG_NSJ_png_convert_to_rfc1123_buffer_IS_DEFINED == 1
        png_nsj_clear_errors(dCallContext);
        return png_convert_to_rfc1123_buffer(out, ptime);
#   else
...
#   endif
 ...
 void png_nsj_convert_from_struct_tm(libpngCallContextForD *dCallContext, png_timep ptime,
...
#   endif
 ...
 void png_nsj_convert_from_time_t(libpngCallContextForD *dCallContext, png_timep ptime, time_t ttime)
{
...
#   endif
 ...
 void png_nsj_set_expand(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_expand_gray_1_2_4_to_8(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_palette_to_rgb(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_tRNS_to_alpha(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_expand_16(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_bgr(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_gray_to_rgb(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_rgb_to_gray(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_rgb_to_gray_fixed(d_png_structrp png_ptr,
...
#   endif
 ...
 png_byte png_nsj_get_rgb_to_gray_status(d_png_const_structrp
    png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_build_grayscale_palette(libpngCallContextForD *dCallContext, int bit_depth,
    png_colorp palette)
{
...
#   endif
 ...
 void png_nsj_set_alpha_mode(d_png_structrp png_ptr, int mode,
    double output_gamma)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_alpha_mode_fixed(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_strip_alpha(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_swap_alpha(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_invert_alpha(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_filler(d_png_structrp png_ptr, png_uint_32 filler,
    int flags)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_add_alpha(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_swap(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_packing(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_packswap(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_shift(d_png_structrp png_ptr, png_const_color_8p
    true_bits)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 int png_nsj_set_interlace_handling(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_invert_mono(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_background(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_background_fixed(d_png_structrp png_ptr,
    png_const_color_16p background_color, int background_gamma_code,
...
#   endif
 ...
 void png_nsj_set_scale_16(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_strip_16(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_quantize(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_gamma(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_gamma_fixed(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_flush(d_png_structrp png_ptr, int nrows)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_write_flush(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_start_read_image(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_read_update_info(d_png_structrp png_ptr,
    png_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_read_rows(d_png_structrp png_ptr, png_bytepp row,
...
#   endif
 ...
 void png_nsj_read_row(d_png_structrp png_ptr, png_bytep row,
...
#   endif
 ...
 void png_nsj_read_image(d_png_structrp png_ptr, png_bytepp image)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_write_row(d_png_structrp png_ptr,
    png_const_bytep row)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_write_rows(d_png_structrp png_ptr, png_bytepp row,
...
#   endif
 ...
 void png_nsj_write_image(d_png_structrp png_ptr, png_bytepp image)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_write_end(d_png_structrp png_ptr,
    png_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_read_end(d_png_structrp png_ptr, png_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_destroy_info_struct(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_crc_action(d_png_structrp png_ptr, int crit_action,
    int ancil_action)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_filter(d_png_structrp png_ptr, int method,
    int filters)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_filter_heuristics(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_filter_heuristics_fixed(d_png_structrp png_ptr, int heuristic_method, int num_weights,
...
#   endif
 ...
 void png_nsj_set_compression_level(d_png_structrp png_ptr,
    int level)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_compression_mem_level(d_png_structrp png_ptr,
    int mem_level)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_compression_strategy(d_png_structrp png_ptr,
    int strategy)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_compression_window_bits(d_png_structrp png_ptr,
    int window_bits)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_compression_method(d_png_structrp png_ptr,
    int method)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_text_compression_level(d_png_structrp png_ptr,
    int level)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_text_compression_mem_level(d_png_structrp png_ptr,
    int mem_level)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_text_compression_strategy(d_png_structrp png_ptr,
    int strategy)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_text_compression_window_bits(d_png_structrp png_ptr, int window_bits)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_text_compression_method(d_png_structrp png_ptr,
    int method)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_init_io(d_png_structrp png_ptr, png_FILE_p fp)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_voidp png_nsj_get_error_ptr(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_write_fn(d_png_structrp png_ptr, png_voidp io_ptr,
...
#   endif
 ...
 void png_nsj_set_read_fn(d_png_structrp png_ptr, png_voidp io_ptr,
...
#   endif
 ...
 png_voidp png_nsj_get_io_ptr(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_read_status_fn(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_write_status_fn(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_mem_fn(d_png_structrp png_ptr, png_voidp mem_ptr,
...
#   endif
 ...
 png_voidp png_nsj_get_mem_ptr(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_read_user_transform_fn(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_write_user_transform_fn(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_user_transform_info(d_png_structrp png_ptr,
...
#   endif
 ...
 png_voidp png_nsj_get_user_transform_ptr(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_current_row_number(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_byte png_nsj_get_current_pass_number(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_read_user_chunk_fn(d_png_structrp png_ptr,
...
#   endif
 ...
 png_voidp png_nsj_get_user_chunk_ptr(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_progressive_read_fn(d_png_structrp png_ptr,
...
#   endif
 ...
 png_voidp png_nsj_get_progressive_ptr(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_process_data(d_png_structrp png_ptr,
...
#   endif
 ...
 size_t png_nsj_process_data_pause(d_png_structrp png_ptr, int save)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_process_data_skip(d_png_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_progressive_combine_row(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_voidp png_nsj_malloc(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_voidp png_nsj_calloc(d_png_const_structrp png_ptr,
    png_alloc_size_t size)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_voidp png_nsj_malloc_warn(d_png_const_structrp png_ptr,
    png_alloc_size_t size)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_free(d_png_const_structrp png_ptr, png_voidp ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_free_data(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_data_freer(d_png_const_structrp png_ptr,
...
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
PNG_DEPRECATED png_voidp png_nsj_malloc_default(d_png_const_structrp png_ptr,
    png_alloc_size_t size)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
PNG_DEPRECATED void png_nsj_free_default(d_png_const_structrp png_ptr,
    png_voidp ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#pragma GCC diagnostic pop
 ...
 void png_nsj_error(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_chunk_error(d_png_const_structrp png_ptr,
    png_const_charp error_message)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_err(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_warning(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_chunk_warning(d_png_const_structrp png_ptr,
    png_const_charp warning_message)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_valid(d_png_const_structrp png_ptr,
...
#   endif
 ...
 size_t png_nsj_get_rowbytes(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_bytepp png_nsj_get_rows(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_rows(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_byte png_nsj_get_channels(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_image_width(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_image_height(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_byte png_nsj_get_bit_depth(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_byte png_nsj_get_color_type(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_byte png_nsj_get_filter_type(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_byte png_nsj_get_interlace_type(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_byte png_nsj_get_compression_type(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_pixels_per_meter(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_x_pixels_per_meter(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_y_pixels_per_meter(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 float png_nsj_get_pixel_aspect_ratio(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_fixed_point png_nsj_get_pixel_aspect_ratio_fixed(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_int_32 png_nsj_get_x_offset_pixels(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_int_32 png_nsj_get_y_offset_pixels(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_int_32 png_nsj_get_x_offset_microns(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_int_32 png_nsj_get_y_offset_microns(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_const_bytep png_nsj_get_signature(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_bKGD(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_bKGD(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_cHRM(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_cHRM_XYZ(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_cHRM_fixed(d_png_const_structrp png_ptr, png_const_inforp info_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_cHRM_XYZ_fixed(d_png_const_structrp png_ptr, png_const_inforp info_ptr,
    png_fixed_point *int_red_X, png_fixed_point *int_red_Y,
...
#   endif
 ...
 void png_nsj_set_cHRM(d_png_const_structrp png_ptr,
    png_inforp info_ptr,
...
#   endif
 ...
 void png_nsj_set_cHRM_XYZ(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_cHRM_fixed(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_cHRM_XYZ_fixed(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_eXIf(d_png_const_structrp png_ptr,
    png_inforp info_ptr, png_bytep *exif)
{
    png_nsj_clear_errors(png_ptr.dCallContext);

#   if PNG_NSJ_png_get_eXIf_IS_DEFINED == 1
        png_ptr.dCallContext->jump_ready = 1;
        if ( setjmp(png_ptr.dCallContext->d_jmp_buf) ) {
            return 0;
        }
        return png_get_eXIf(png_ptr.png_ptr, info_ptr, exif);
#   else
        png_nsj_set_missing_fn_err(png_ptr.dCallContext);
        return 0;
#   endif
 ...
 void png_nsj_set_eXIf(d_png_const_structrp png_ptr,
    png_inforp info_ptr, const png_bytep exif)
{
    png_nsj_clear_errors(png_ptr.dCallContext);

#   if PNG_NSJ_png_set_eXIf_IS_DEFINED == 1
        png_ptr.dCallContext->jump_ready = 1;
        if ( setjmp(png_ptr.dCallContext->d_jmp_buf) ) {
            return;
        }
        png_set_eXIf(png_ptr.png_ptr, info_ptr, exif);
#   else
        png_nsj_set_missing_fn_err(png_ptr.dCallContext);
        return;
#   endif
 ...
 png_uint_32 png_nsj_get_eXIf_1(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr, png_uint_32 *num_exif, png_bytep *exif)
{
    png_nsj_clear_errors(png_ptr.dCallContext);

#   if PNG_NSJ_png_get_eXIf_1_IS_DEFINED == 1
        png_ptr.dCallContext->jump_ready = 1;
        if ( setjmp(png_ptr.dCallContext->d_jmp_buf) ) {
            return 0;
        }
        return png_get_eXIf_1(png_ptr.png_ptr, info_ptr, num_exif, exif);
#   else
        png_nsj_set_missing_fn_err(png_ptr.dCallContext);
        return 0;
#   endif
 ...
 void png_nsj_set_eXIf_1(d_png_const_structrp png_ptr,
    png_inforp info_ptr, const png_uint_32 num_exif, const png_bytep exif)
{
    png_nsj_clear_errors(png_ptr.dCallContext);

#   if PNG_NSJ_png_set_eXIf_1_IS_DEFINED == 1
        png_ptr.dCallContext->jump_ready = 1;
        if ( setjmp(png_ptr.dCallContext->d_jmp_buf) ) {
            return;
        }
        png_set_eXIf_1(png_ptr.png_ptr, info_ptr, num_exif, exif);
#   else
        png_nsj_set_missing_fn_err(png_ptr.dCallContext);
        return;
#   endif
 ...
 png_uint_32 png_nsj_get_gAMA(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_gAMA_fixed(d_png_const_structrp png_ptr, png_const_inforp info_ptr,
...
#   endif
 ...
 void png_nsj_set_gAMA(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_gAMA_fixed(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_hIST(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_hIST(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_IHDR(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_IHDR(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_oFFs(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_oFFs(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_pCAL(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_pCAL(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_pHYs(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_pHYs(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_PLTE(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_PLTE(d_png_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_sBIT(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_sBIT(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_sRGB(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_sRGB(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_sRGB_gAMA_and_cHRM(d_png_const_structrp png_ptr,
    png_inforp info_ptr, int srgb_intent)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_iCCP(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_iCCP(d_png_const_structrp png_ptr,
...
#   endif
 ...
 int png_nsj_get_sPLT(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_sPLT(d_png_const_structrp png_ptr,
...
#   endif
 ...
 int png_nsj_get_text(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_text(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_tIME(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_tIME(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_tRNS(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_tRNS(d_png_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_sCAL(d_png_const_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_sCAL_fixed(d_png_const_structrp png_ptr, png_const_inforp info_ptr, int *unit,
...
#   endif
 ...
 png_uint_32 png_nsj_get_sCAL_s(d_png_const_structrp png_ptr, png_const_inforp info_ptr, int *unit,
...
#   endif
 ...
 void png_nsj_set_sCAL(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_sCAL_fixed(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_sCAL_s(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_keep_unknown_chunks(d_png_structrp png_ptr,
...
#   endif
 ...
 int png_nsj_handle_as_unknown(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_unknown_chunks(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_unknown_chunk_location(d_png_const_structrp png_ptr, png_inforp info_ptr, int chunk, int location)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 int png_nsj_get_unknown_chunks(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_invalid(d_png_const_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_read_png(d_png_structrp png_ptr, png_inforp info_ptr,
...
#   endif
 ...
 void png_nsj_write_png(d_png_structrp png_ptr, png_inforp info_ptr,
    int transforms, png_voidp params)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_const_charp png_nsj_get_copyright(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_const_charp png_nsj_get_header_ver(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_const_charp png_nsj_get_header_version(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_const_charp png_nsj_get_libpng_ver(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_permit_mng_features(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_strip_error_numbers(d_png_structrp png_ptr,
...
#   endif
 ...
 void png_nsj_set_user_limits(d_png_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_user_width_max(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_user_height_max(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_chunk_cache_max(d_png_structrp png_ptr,
...
#   endif
 ...
 png_uint_32 png_nsj_get_chunk_cache_max(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_set_chunk_malloc_max(d_png_structrp png_ptr,
...
#   endif
 ...
 png_alloc_size_t png_nsj_get_chunk_malloc_max(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_pixels_per_inch(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_x_pixels_per_inch(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_y_pixels_per_inch(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 float png_nsj_get_x_offset_inches(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_fixed_point png_nsj_get_x_offset_inches_fixed(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 float png_nsj_get_y_offset_inches(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_fixed_point png_nsj_get_y_offset_inches_fixed(d_png_const_structrp png_ptr, png_const_inforp info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_pHYs_dpi(d_png_const_structrp png_ptr,
    png_const_inforp info_ptr, png_uint_32 *res_x, png_uint_32 *res_y,
    int *unit_type)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_io_state(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
*/ png_uint_32 png_nsj_get_io_chunk_type(d_png_const_structrp png_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 png_uint_32 png_nsj_get_uint_32(libpngCallContextForD *dCallContext, png_const_bytep buf)
{
...
#   endif
 ...
 png_uint_16 png_nsj_get_uint_16(libpngCallContextForD *dCallContext, png_const_bytep buf)
{
...
#   endif
 ...
 png_int_32 png_nsj_get_int_32(libpngCallContextForD *dCallContext, png_const_bytep buf)
{
...
#   endif
 ...
 png_uint_32 png_nsj_get_uint_31(d_png_const_structrp png_ptr,
    png_const_bytep buf)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 void png_nsj_save_uint_32(libpngCallContextForD *dCallContext, png_bytep buf, png_uint_32 i)
{
...
#   endif
 ...
 void png_nsj_save_int_32(libpngCallContextForD *dCallContext, png_bytep buf, png_int_32 i)
{
...
#   endif
 ...
 void png_nsj_save_uint_16(libpngCallContextForD *dCallContext, png_bytep buf, unsigned int i)
{
...
#   endif
 ...
 void png_nsj_set_check_for_invalid_index(d_png_structrp png_ptr, int allowed)
{
    png_nsj_clear_errors(png_ptr.dCallContext);
...
#   endif
 ...
 int png_nsj_get_palette_max(d_png_const_structp png_ptr,
    png_const_infop info_ptr)
{
    png_nsj_clear_errors(png_ptr.dCallContext);

#   if PNG_NSJ_png_get_palette_max_IS_DEFINED == 1
        png_ptr.dCallContext->jump_ready = 1;
        if ( setjmp(png_ptr.dCallContext->d_jmp_buf) ) {
            return 0;
        }
        return png_get_palette_max(png_ptr.png_ptr, info_ptr);
#   else
        png_nsj_set_missing_fn_err(png_ptr.dCallContext);
        return 0;
#   endif
 ...
 int png_nsj_image_begin_read_from_file(libpngCallContextForD *dCallContext, png_imagep image,
   const char *file_name)
{
#   if PNG_NSJ_png_image_begin_read_from_file_IS_DEFINED == 1
        png_nsj_clear_errors(dCallContext);
...
#   endif
 ...
 int png_nsj_image_begin_read_from_stdio(libpngCallContextForD *dCallContext, png_imagep image,
   FILE* file)
{
#   if PNG_NSJ_png_image_begin_read_from_stdio_IS_DEFINED == 1
        png_nsj_clear_errors(dCallContext);
        return png_image_begin_read_from_stdio(image, file);
#   else
        png_nsj_set_missing_fn_err(dCallContext);
        return 0;
#   endif
 ...
 int png_nsj_image_begin_read_from_memory(libpngCallContextForD *dCallContext, png_imagep image,
   png_const_voidp memory, size_t size)
{
#   if PNG_NSJ_png_image_begin_read_from_memory_IS_DEFINED == 1
        png_nsj_clear_errors(dCallContext);
        return png_image_begin_read_from_memory(image, memory, size);
#   else
        png_nsj_set_missing_fn_err(dCallContext);
        return 0;
#   endif
 ...
 int png_nsj_image_finish_read(libpngCallContextForD *dCallContext, png_imagep image,
   png_const_colorp background, void *buffer, png_int_32 row_stride,
   void *colormap)
{
#   if PNG_NSJ_png_image_finish_read_IS_DEFINED == 1
        png_nsj_clear_errors(dCallContext);
...
#   endif
 ...
 void png_nsj_image_free(libpngCallContextForD *dCallContext, png_imagep image)
{
#   if PNG_NSJ_png_image_free_IS_DEFINED == 1
        png_nsj_clear_errors(dCallContext);
...
#   endif
 ...
 int png_nsj_image_write_to_file(libpngCallContextForD *dCallContext, png_imagep image,
   const char *file, int convert_to_8bit, const void *buffer,
   png_int_32 row_stride, const void *colormap)
{
#   if PNG_NSJ_png_image_write_to_file_IS_DEFINED == 1
        png_nsj_clear_errors(dCallContext);
...
#   endif
 ...
 int png_nsj_image_write_to_stdio(libpngCallContextForD *dCallContext, png_imagep image, FILE *file,
   int convert_to_8_bit, const void *buffer, png_int_32 row_stride,
   const void *colormap)
{
#   if PNG_NSJ_png_image_write_to_stdio_IS_DEFINED == 1
        png_nsj_clear_errors(dCallContext);
        return png_image_write_to_stdio(image, file, convert_to_8_bit, buffer, row_stride, colormap);
#   else
        png_nsj_set_missing_fn_err(dCallContext);
        return 0;
#   endif
 ...
 int png_nsj_image_write_to_memory(libpngCallContextForD *dCallContext, png_imagep image, void *memory,
   png_alloc_size_t * PNG_RESTRICT memory_bytes, int convert_to_8_bit,
   const void *buffer, png_int_32 row_stride, const void *colormap)
{
#   if PNG_NSJ_png_image_write_to_memory_IS_DEFINED == 1
        png_nsj_clear_errors(dCallContext);
...
#   endif
 ...
 int png_nsj_set_option(d_png_structrp png_ptr, int option,
   int onoff)
{
    png_nsj_clear_errors(png_ptr.dCallContext);

#   if PNG_NSJ_png_set_option_IS_DEFINED == 1
        png_ptr.dCallContext->jump_ready = 1;
        if ( setjmp(png_ptr.dCallContext->d_jmp_buf) ) {
            return 0;
        }
        return png_set_option(png_ptr.png_ptr, option, onoff);
#   else
        png_nsj_set_missing_fn_err(png_ptr.dCallContext);
        return 0;
#   endif
